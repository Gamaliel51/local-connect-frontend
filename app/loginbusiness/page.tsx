...
export default function BusinessLogin() {
  ...
  return (
    <div className="max-w-lg mx-auto mt-28 bg-white dark:bg-gray-800 rounded-lg shadow-md px-8 py-10 flex flex-col items-center">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-300 mt-4">
        ...
        <Link href="/registerbusiness" className="text-blue-500">
          Sign Up
        </Link>
      </p>
    </div>
