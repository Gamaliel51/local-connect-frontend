...
export default function UserLogin() {
  ...
  return (
    <div className="max-w-lg mt-28 mx-auto bg-white rounded-lg shadow-md px-8 py-10 flex flex-col items-center">
      <h1 className="text-xl font-bold text-center text-blue-900 mb-8">
        User Login
      </h1>
      ...
      <Link 
        href="/loginbusiness" 
        className="text-blue-600 hover:text-blue-700 mt-2 font-light text-xs"
      >
