    ...
    <nav className="fixed w-full top-0 z-50 bg-black/10 backdrop-blur-lg transition-colors duration-300 md:px-10 lg:px-10">
      <div className="container mx-auto flex h-20 items-center justify-between px-4">
        ...
        <div className="hidden md:flex items-center md:gap-8 text-white">
          <Link href="/businessdashboard" className="text-sm font-medium hover:text-purple-400 transition">Home</Link>
          {/* <Link href="#about" className="text-sm font-medium hover:text-purple-400 transition">A</Link>
          <Link href="/register" className="text-sm font-medium hover:text-purple-400 transition">Register</Link> */}
          <button className="cursor-pointer rounded-full border-2 py-2 px-6 border-white bg-white text-purple-900 hover:bg-purple-900 hover:text-white hover:shadow-lg transition duration-300 ease-in-out">
            Log Out
          </button>
        </div>
